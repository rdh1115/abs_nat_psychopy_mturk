// Configuration object for the interdms ABBA obj obj task

export const TASK_CONFIG = {
    // ----- Basic experiment metadata -----
    expName: 'interdms_ABBA_obj_obj',

    // Which CSV to use for trials
    // trialsCsv: 'resources/interdms_debug.csv',
    trialsCsv: 'resources/interdms_ABBA_obj_obj_trials.csv',
    ...
    // Texts
    welcomeText: `
• You will perform an Interleaved Delayed Match-to-Sample ABBA Object–Object task.
...
Press Enter to begin the learning session.`;
    ...
    makeFrameInstruction(frameIdx, isLearning) {
        ...
        if (frameIdx === 0) {
            ...
            return 'Compare IDENTITY with the SECOND image.\n' +
