// Configuration object for the interdms ABAB category category task

export const TASK_CONFIG = {
    // ----- Basic experiment metadata -----
    expName: 'interdms_ABAB_category_category',

    // Which CSV to use for trials
    // trialsCsv: 'resources/interdms_debug.csv',
    trialsCsv: 'resources/interdms_ABAB_category_category_trials.csv',
...
• You will perform an Interleaved Delayed Match-to-Sample ABAB Category–Category task.
...
Press Enter to begin the learning session.`;
    ...
    makeFrameInstruction(frameIdx, isLearning) {
        ...
        if (frameIdx === 0) {
            ...
            return 'Compare CATEGORY with the THIRD image.\n' +
                'Press X if same, B if different.';
        } else {
            return '';
        }
