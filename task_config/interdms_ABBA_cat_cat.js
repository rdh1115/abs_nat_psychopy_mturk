// Configuration object for the interdms ABBA category category task

export const TASK_CONFIG = {
    // ----- Basic experiment metadata -----
    expName: 'interdms_ABBA_category_category',

    // Which CSV to use for trials
    // trialsCsv: 'resources/interdms_debug.csv',
    trialsCsv: 'resources/interdms_ABBA_category_category_trials.csv',
...
Press Enter to begin the learning session.`;
    ...
    makeFrameInstruction(frameIdx, isLearning) {
        ...
        if (frameIdx === 0) {
            ...
            return 'Compare CATEGORY with the SECOND image.\n' +
