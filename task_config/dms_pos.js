// Configuration object for the DMS position task

export const TASK_CONFIG = {
    // ----- Basic experiment metadata -----
    expName: 'dms_position',

    // Which CSV to use for trials
    // trialsCsv: 'resources/1back_debug.csv',
    trialsCsv: 'resources/dms_pos_trials.csv',
    ...
    stimFieldNames: ['stim1', 'stim2'],
    actFieldNames: [null, 'act2'],
    ...
    // Texts
    welcomeText: `
• You will complete a Delayed Match-to-Sample task.

• Each trial contains 2 images (frames). On the 2nd frame, press:
    - 'X' if the position of the current image matches the previous one,
