// Configuration object for the interdms ABAB position position task

export const TASK_CONFIG = {
    // ----- Basic experiment metadata -----
    expName: 'interdms_ABAB_pos_pos',

    // Which CSV to use for trials
    // trialsCsv: 'resources/interdms_debug.csv',
    trialsCsv: 'resources/interdms_ABAB_pos_pos_trials.csv',
    ...
    // Texts
    welcomeText: `
• You will perform an Interleaved Delayed Match-to-Sample ABAB Position–Position task.
...
Press Enter to begin the learning session.`;
    ...
    makeFrameInstruction(frameIdx, isLearning) {
        ...
        if (frameIdx === 0) {
            ...
            return 'Compare POSITION with the THIRD image.\n' +
                'Press X if same, B if different.';
        } else {
            return '';
        }
