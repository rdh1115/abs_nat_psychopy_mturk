...
export const TASK_CONFIG = {
    ...
    expName: 'ctxdms_category_identity_position_debug',

    // Which CSV to use for trials
    // trialsCsv: 'resources/interdms_debug.csv',
    trialsCsv: 'resources/ctxdms_category_obj_pos_debug_trials.csv',
...
Press Enter to begin the learning session.`;
    ...
    makeFrameInstruction(frameIdx, isLearning) {
        ...
        if (frameIdx === 0) {
            ...
            return 'If their categories matched, compare IDENTITY with the SECOND image.\n' +
